...
export type UserState =
  ...
  | "DRIVER_RESET_DOCUMENT"
  | "DRIVER_RESET_PASSWORD"
  | "DRIVER_RESET_CONFIRM"
  | "DRIVER_PREFERRED_NAME"
  | "FAVORITE_OFFER"
  | "FAVORITE_NAME_CHOICE"
  | "FAVORITE_CUSTOM_NAME"
  | "WAITING_FULL_NAME"
  | "WAITING_PREFERRED_NAME"
  | "WAITING_REGISTRATION_SOURCE"
  | "DRIVER_UPDATE_CATEGORY"
  | "DRIVER_UPDATE_SELECT_FIELD"
  | "DRIVER_UPDATE_VALUE"
  | "DRIVER_UPDATE_EMAIL_PASSWORD"
  | "DRIVER_UPDATE_CONFIRM"
  | "DRIVER_UPDATE_EXPIRED_DOCS"
  | "DRIVER_PHONE_CHANGE_DOCUMENT"
  | "DRIVER_PHONE_CHANGE_PASSWORD"
  | "DRIVER_PHONE_CHANGE_NEW_NUMBER"
  | "DRIVER_PHONE_CHANGE_AWAIT_CONFIRM"
